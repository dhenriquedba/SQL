Rem
Rem $Header: sprepins.sql 21-mar-2003.18:36:19 vbarrier Exp $
Rem
Rem sprepins.sql
Rem
...
Rem    Odécio      jun2008  - modified to generate a sequence of SnapshotsRem    vbarrier    03/21/03 - 2726042
...
/
set echo off feedback off pagesize 60 linesize 80 newpage 1 recsep off set termout on
...
btitle off;
repfooter off;
set linesize 78 termout on feedback 6 flush off
undefine begin_snap
undefine end_snap
undefine dbid
undefine inst_num
