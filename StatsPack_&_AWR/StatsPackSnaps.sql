...
exec dbms_job.submit(:x,'statspack.snap(i_snap_level=>10);',to_date('12062008:123000','ddmmyyyy:hh24miss'),'sysdate+1/48')
*/
rem exec dbms_job.submit(:x,'statspack.snap;',sysdate,'sysdate+30/1440')
rem exec dbms_job.submit(:X,'statspack.snap;', to_date('110720070001','ddmmyyyyhh24mi'),'sysdate+1/24')
rem exec dbms_job.submit(:X,'statspack.snap;', to_date('100620080000','ddmmyyyyhh24mi'),'sysdate+1/48')
...
Prompt
Prompt Ed StatsPackSnaps       @ StatsPackSnaps
Prompt
