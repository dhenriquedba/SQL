SELECT c.DESC_TX scenario,  TO_CHAR(a.start_ts, 'dd/mm/yyyy') DATA,
   ...
   WHERE a.job_id = b.JOB_ID
       ...
       AND c.desc_tx in 
('ML-RapidMvmntFundsAllActivity-fAC-BRPF')

('ML-ChkMiRecurringReBeKnown-fAC-rBene-BRPF',
'ML-ChkMiRecurringReBeKnown-fAC-rRem-BRPF',
'ML-HighRiskTransFocalHRE-fAC-BRWC',
'ML-HRTransHRCounterParty-fCU-BRPF',
'ML-CashTransPossibleCTR-fCU-BRPF',
'ML-CashTransPossibleCTR-fCU-BRWC',
'ML-HRTransHRCounterParty-fAC-BRPF',
'ML-CashTransSignificantCash-fCU-BRPF',
'ML-HighRiskTransFocalHRE-fCU-BRPF',
'ML-HighRiskTransFocalHRE-fAC-BRPF',
'ML-LargeReportableTrans-fCU-BRPF',
'ML-CashTransSignificantCash-fCU-BRPC',
'ML-RapidMvmntFundsAllActivity-fCU-BRPF',
'ML-HRTransHRCounterParty-fCU-BRPC',
'ML-HighRiskTransFocalHRE-fCU-BRWC',
'ML-HRTransHRCounterParty-fAC-BRPC',
'ML-RapidMvmntFundsAllActivity-fAC-BRPF',
'ML-RapidMvmntFundsAllActivity-fCU-BRPC',
'ML-ChkMiRecurringReBeKnown-fAC-rBene-BRPC',
'ML-ChkMiRecurringReBeKnown-fAC-rRem-BRPC')
 ORDER BY 1,2
