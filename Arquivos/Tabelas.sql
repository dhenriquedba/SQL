...
Create user aluno1 identified by aluno1 account unlock
	default tablespace sysaux;
grant DBA to aluno1;

connect aluno1/aluno1

Show user
prompt
prompt Observe acima se o usuário ""aluno1"" está conectado !!!
prompt
prompt CUIDADO !!!  !!!  todos os objetos existentes serão DESTRUIDOS  !!!  !!!  
prompt Pressione [Enter] para continuar, [Ctrl]+[C] para desistir
pause
